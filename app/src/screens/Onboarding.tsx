...
export function Onboarding() {
  const { finishOnboarding, authenticate, acceptOAuthHandoff, signInWithMagic } = useApp();
  ...
  // OAuth/magic callback lands with ?authed=1 — session is in an HttpOnly cookie,
